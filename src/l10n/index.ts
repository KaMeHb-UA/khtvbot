...
export type Phrases = {
	...
	admin_debug_cmd: Record<string, never>;
	admin_debug_view: Record<string, never>;
	admin_throw_error_cmd: Record<string, never>;
	admin_throw_error_reply: Record<string, never>;
};
